...
/**
  ...
  *
  * @checksum - c7ee957cf2bbe08a392cdaa3b1e4398dde163ed7f11d63dba112302601343d63
  * @variables - radius=rounded,accentColor=orange,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
